...
interface MobileConsciousnessPreviewProps {
  name: string
...
export function MobileConsciousnessPreview({
  name,
  parameters,
  monicaConstant,
  alchemicalValues,
  ...
  return (
    ...
    >
      ...
      <CardContent className="space-y-4">
        {/* Mobile Consciousness Description */}
        <div className="p-3 bg-purple-900/20 rounded-lg border border-purple-500/30">
          <h3 className="text-sm font-semibold text-purple-300 mb-1">Consciousness Profile</h3>
          <p className="text-slate-300 text-xs leading-relaxed">
            {archetype.description}. {consciousnessLevel.description}.
          </p>
        </div>
        ...
        <Accordion type="single" collapsible>
          <AccordionItem value="communication" className="border-purple-500/30">
            ...
            <AccordionContent>
              <p className="text-slate-300 text-xs leading-relaxed bg-slate-800/50 p-3 rounded-lg">
                {getCommunicationStyle}
              </p>
            </AccordionContent>
          </AccordionItem>

          <AccordionItem value="strengths" className="border-purple-500/30">
            <AccordionTrigger className="text-purple-300 hover:text-purple-200 text-sm">
              <div className="flex items-center gap-2">
                ...
                {personalityInsights
                  ...
                  .map((insight, index) => (
                    ...
                    >
                      ...
                      <div className="text-xs font-mono text-slate-300">{insight.strength}</div>
                    </div>
                  ))}
              </div>
            </AccordionContent>
          ...
          <AccordionItem value="alchemical" className="border-purple-500/30">
            <AccordionTrigger className="text-purple-300 hover:text-purple-200 text-sm">
              <div className="flex items-center gap-2">
              ...
              <div className="space-y-2">
                {[
                  ...
                  <div key={mode.name} className="flex items-center gap-2">
                    ...
                    <span className="w-8 text-xs text-slate-400">{mode.value}</span>
                  </div>
                ))}
              </div>
            </AccordionContent>
...
export default MobileConsciousnessPreview
