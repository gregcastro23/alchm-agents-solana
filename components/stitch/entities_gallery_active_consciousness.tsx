export default function EntitiesGalleryActiveConsciousness() {
  return (
      ...
      <nav className="hidden md:flex bg-obsidian-deep/60 backdrop-blur-xl docked full-width top-0 z-50 border-b border-white/10 shadow-[0_0_20px_rgba(168,85,247,0.2)] fixed top-0 w-full justify-between items-center px-gutter py-4">
        ...
        <div className="flex items-center space-x-6">
          <div className="flex space-x-4 text-on-surface-variant">
            <span
              className="material-symbols-outlined hover:text-st-primary transition-colors cursor-pointer"
      ...
      <main className="flex-grow pt-24 md:pt-32 pb-16 px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto w-full">
        ...
        <div className="mb-16 text-center md:text-left">
          ...
          <p className="font-body-lg text-body-lg text-on-surface-variant max-w-2xl mx-auto md:mx-0">
            ...
            historical minds resurrected, and your own alchemical creations.
          </p>
        </div>
        {/*  Filters / Navigation  */}
        ...
        <section className="mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/*  Agent Card 1  */}
            <div className="glass-panel rounded-xl p-6 glow-hover transition-all duration-300 cursor-pointer group relative overflow-hidden">
              ...
              <div className="flex gap-4 items-center">
                ...
                <div className="grid grid-cols-2 gap-2 flex-grow">
                  <div className="bg-surface-container-highest/50 rounded p-2 border border-white/5">
