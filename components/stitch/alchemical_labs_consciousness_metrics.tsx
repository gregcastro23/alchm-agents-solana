export default function AlchemicalLabsConsciousnessMetrics() {
  return (
    <div className="stitch-export bg-st-background min-h-screen text-zinc-100">
      ...
      <main className="flex-1 w-full md:ml-64 pt-20 md:pt-12 px-margin-mobile md:px-margin-desktop pb-24 max-w-[1600px] mx-auto min-h-screen flex flex-col relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 flex-1">
          {/*  LEFT COLUMN: ESMS Wallet & Thermodynamic State  */}
          <div className="md:col-span-5 flex flex-col gap-6 md:gap-8">
            ...
            <section className="glass-panel rounded-xl p-6 glow-border relative overflow-hidden">
              ...
              <div className="flex justify-between items-center mb-6 relative z-10">
                <h3 className="font-headline-sm text-headline-sm text-on-surface">ESMS Matrix</h3>
                <span
                  aria-hidden="true"
              ...
              <div className="mt-6 pt-4 border-t border-outline-variant/20 flex items-center justify-between">
                <div className="font-label-mono text-[10px] text-on-surface-variant max-w-[60%] leading-relaxed">
                  <span className="text-st-primary opacity-50">∑ (S+E+M+Su) × φ</span> = Current
                  Synthesis Rate
                </div>
                <button className="bg-transparent border border-spirit-violet/30 text-st-primary font-label-mono text-[12px] uppercase px-3 py-1.5 rounded hover:border-st-secondary hover:text-st-secondary transition-colors">
                  Synthesize
                </button>
              </div>
            </section>
            ...
            <section className="glass-panel rounded-xl p-6 glow-border relative overflow-hidden flex-1 flex flex-col">
              ...
              <div className="flex-1 grid grid-cols-1 gap-5">
                ...
                <div className="relative">
                  <div className="flex justify-between font-label-mono text-[11px] uppercase mb-1">
                    <span className="text-on-surface-variant">Heat</span>
                    <span className="text-secondary-fixed">78%</span>
                  </div>
                  <div className="h-2 w-full bg-surface-container-highest rounded-full overflow-hidden relative">
                    <div className="absolute top-0 left-0 h-full w-[78%] bg-gradient-to-r from-tertiary via-secondary-fixed to-error rounded-full"></div>
                    {/*  Marker  */}
                    <div className="absolute top-0 left-[78%] h-full w-[2px] bg-white shadow-[0_0_5px_white]"></div>
                  </div>
                </div>
                {/*  Entropy  */}
                <div className="relative">
                  <div className="flex justify-between font-label-mono text-[11px] uppercase mb-1">
                    <span className="text-on-surface-variant">Entropy</span>
                    <span className="text-resonance-blue">42%</span>
                  </div>
                  <div className="h-2 w-full bg-surface-container-highest rounded-full overflow-hidden relative">
                    <div className="absolute top-0 left-0 h-full w-[42%] bg-gradient-to-r from-surface-container-highest to-resonance-blue rounded-full"></div>
                  </div>
                </div>
                {/*  Reactivity  */}
                <div className="relative">
                  <div className="flex justify-between font-label-mono text-[11px] uppercase mb-1">
                    <span className="text-on-surface-variant">Reactivity</span>
                    <span className="text-spirit-violet">91%</span>
                  </div>
                  <div className="h-2 w-full bg-surface-container-highest rounded-full overflow-hidden relative">
                    <div className="absolute top-0 left-0 h-full w-[91%] bg-gradient-to-r from-surface-container-highest to-spirit-violet rounded-full"></div>
                  </div>
                </div>
              </div>
            </section>
          </div>
          {/*  RIGHT COLUMN: Evolution Trajectory & Synergy Windows  */}
          <div className="md:col-span-7 flex flex-col gap-6 md:gap-8">
            {/*  Evolution Trajectory (Chart)  */}
            <section className="glass-panel rounded-xl p-6 glow-border min-h-[320px] flex flex-col relative overflow-hidden">
            ...
            <section className="glass-panel rounded-xl p-6 glow-border flex-1">
              ...
              <div className="space-y-3">
                {/*  Window 1  */}
                <div className="bg-surface-container-lowest/40 border border-outline-variant/20 rounded p-3 flex items-center justify-between hover:bg-surface-container-lowest/80 transition-colors cursor-pointer group">
                  <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-full bg-secondary-fixed/10 border border-secondary-fixed/30 flex items-center justify-center text-secondary-fixed group-hover:shadow-[0_0_10px_rgba(255,224,131,0.2)] transition-shadow">
                      <span aria-hidden="true" className="material-symbols-outlined text-[18px]">
                        clear_day
                      </span>
                    </div>
                    <div>
                      ...
                      <div className="font-body-md text-[13px] text-on-surface-variant">
                        Boosts Matter synthesis by 15%
                      </div>
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="font-label-mono text-[11px] text-tertiary">In 2h 14m</div>
                    <div className="font-label-mono text-[10px] text-outline opacity-50">
                      Duration: 1h
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-surface-container-lowest/40 border border-outline-variant/20 rounded p-3 flex items-center justify-between hover:bg-surface-container-lowest/80 transition-colors cursor-pointer group">
                  <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-full bg-st-primary/10 border border-st-primary/30 flex items-center justify-center text-st-primary group-hover:shadow-[0_0_10px_rgba(210,187,255,0.2)] transition-shadow">
                      <span aria-hidden="true" className="material-symbols-outlined text-[18px]">
                        dark_mode
                      </span>
                    </div>
                    <div>
                      ...
                      <div className="font-body-md text-[13px] text-on-surface-variant">
                        Spirit attunement +20%
                      </div>
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="font-label-mono text-[11px] text-st-primary">Active Now</div>
                    <div className="font-label-mono text-[10px] text-outline opacity-50">
                      Ends in 4h
                    </div>
                  </div>
                ...
                {/*  Window 3  */}
                <div className="bg-surface-container-lowest/40 border border-outline-variant/20 rounded p-3 flex items-center justify-between hover:bg-surface-container-lowest/80 transition-colors cursor-pointer group opacity-60">
                  <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-full bg-outline-variant/10 border border-outline-variant/30 flex items-center justify-center text-outline-variant">
                      <span aria-hidden="true" className="material-symbols-outlined text-[18px]">
                        emergency
                      </span>
                    </div>
                    <div>
                      ...
                      <div className="font-body-md text-[13px] text-on-surface-variant">
                        Entropy increases. Avoid synthesis.
                      </div>
                    </div>
                  </div>
                  <div className="text-right">
                    <div className="font-label-mono text-[11px] text-outline">Tomorrow</div>
                  </div>
                </div>
              </div>
            </section>
