export default function AlchemicalLabsTransmutedRecordEconomyEdition() {
  return (
      ...
      <main className="flex-grow flex items-center justify-center p-gutter md:p-margin-desktop relative z-10">
        ...
        <article className="glass-panel w-full max-w-5xl rounded-xl overflow-hidden shadow-[0_0_40px_rgba(168,85,247,0.1)] flex flex-col md:flex-row border-t border-t-spirit-violet/20">
          ...
          <section className="w-full md:w-5/12 p-8 border-b md:border-b-0 md:border-r border-white/5 flex flex-col relative">
            ...
            {/*  Monica Constant (A#)  */}
            <div className="mb-6 p-4 rounded-lg bg-surface-container-lowest/50 border border-white/5">
              <p className="font-label-mono text-xs text-primary-fixed-dim uppercase mb-3 tracking-widest">
                ESMS Transaction Ledger
              </p>
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col">
                  <span className="text-xs text-on-surface-variant">Spirit Yield</span>
                  <span className="text-headline-sm text-tertiary">+120</span>
                </div>
                <div className="flex flex-col">
                  <span className="text-xs text-on-surface-variant">Matter Decay</span>
                  <span className="text-headline-sm text-error">-40</span>
                </div>
              </div>
            </div>
          ...
          <section className="w-full md:w-7/12 p-8 flex flex-col bg-surface-dim/30 relative">
            ...
            <div className="flex-grow mb-10">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-center justify-between text-xs py-2 border-b border-white/5 opacity-80 italic">
                  <div className="flex items-center gap-3">
                    <span
                      aria-hidden="true"
                      className="material-symbols-outlined text-[14px] text-st-secondary"
                    >
                      swap_horiz
                    </span>
                    <span className="font-body-md text-on-surface-variant">
                      Mercury drained 15 Substance from Saturn via Air Strike
                    </span>
                  </div>
                </li>
              </ul>
            ...
            <div className="mb-10">
              <h2 className="font-label-mono text-label-mono text-primary-fixed-dim mb-4 uppercase flex items-center gap-2">
                ...
                Sacred Seven Evolution
              </h2>
              <div className="grid grid-cols-2 gap-3">
                <div className="p-3 rounded bg-surface-container/40 border border-white/5 flex justify-between items-center">
                  <span className="text-xs font-label-mono text-on-surface-variant">MERCURY</span>
                  <span className="text-xs font-bold text-tertiary">+2 WIS</span>
                </div>
                <div className="p-3 rounded bg-surface-container/40 border border-white/5 flex justify-between items-center">
                  <span className="text-xs font-label-mono text-on-surface-variant">SATURN</span>
                  <span className="text-xs font-bold text-resonance-blue">+1 PWR</span>
                </div>
              </div>
            </div>
            {/*  Action Buttons  */}
